...
func TestPixelHandler_ServeHTTP(t *testing.T) {
	...
	expected := `page_visits{host="example.org",page="/some/page",country="DE",region="Land Berlin",city="Berlin",is_eu="true",ua_name="Chrome",ua_version="93",os="Android",is_bot="false",is_mobile="true"} 3` + "\n"
	if actual != expected {
